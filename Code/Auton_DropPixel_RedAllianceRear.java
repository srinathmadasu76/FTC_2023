...
@Autonomous(name="Auton_DropPixel_RedAllianceRear", group="Robot")
//@Disabled
public class Auton_DropPixel_RedAllianceRear extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       // while (opModeIsActive() && (runtime.seconds() < 2)) {
         //   telemetry.addData("Sensor", "Leg 3: %4.1f S Elapsed", valueleftmeasure);
         //   telemetry.update();
       // }
